...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = DUT_PWM_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(DUT_PWM_2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = DUT_PWM_3_Pin|DUT_PWM_4_Pin|GPIO_PIN_4|DUT_PWM_5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA2     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = SENSOR_5V_8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(SENSOR_5V_8_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = GPIO_PIN_6|SENSOR_5V_2_Pin|SENSOR_5V_4_Pin|SENSOR_5V_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM24_MspPostInit 0 */
    ...
    PF14     ------> TIM24_CH4
    */
    GPIO_InitStruct.Pin = NTC_4_Pin|NTC_2_Pin|NTC_1_Pin|SENSOR_5V_7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOE, DUT_PWM_11_Pin|DUT_PWM_12_Pin|DUT_PWM_10_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA2     ------> TIM2_CH3
    */
    HAL_GPIO_DeInit(GPIOA, DUT_PWM_2_Pin|SENSOR_5V_8_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, DUT_PWM_3_Pin|DUT_PWM_4_Pin|GPIO_PIN_4|DUT_PWM_5_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOD, DUT_PWM_7_Pin|DUT_PWM_6_Pin|DUT_PWM_8_Pin|DUT_PWM_9_Pin);
