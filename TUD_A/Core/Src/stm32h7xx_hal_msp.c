...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_11|PWM_5V_8_Pin|PWM_5V_7_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    HAL_GPIO_DeInit(GPIOA, SENSOR_3V_1A0_Pin|PWM_5V_1_Pin|SENSOR_3V_5_Pin|SENSOR_3V_8_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, PWM_5V_2_Pin|PWM_5V_9_Pin|PWM_5V_4_Pin);

    HAL_GPIO_DeInit(SENSOR_3V_12_GPIO_Port, SENSOR_3V_12_Pin);
